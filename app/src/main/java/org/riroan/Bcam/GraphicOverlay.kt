...
class GraphicOverlay(context: Context?, attrs: AttributeSet?) :
    ...
    private var mFacing = CameraSelector.DEFAULT_BACK_CAMERA
    ...
    abstract class Graphic(private val mOverlay: GraphicOverlay) {
        ...
        fun translateX(x: Float): Float {
            return if (mOverlay.mFacing == CameraSelector.DEFAULT_FRONT_CAMERA) {
     ...
     */
    fun setCameraInfo(previewWidth: Int, previewHeight: Int, facing: CameraSelector) {
        synchronized(mLock) {
